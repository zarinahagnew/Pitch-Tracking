...
for trial=1:5
    ...
    plot(frame_taxis(1:1111),dist_pats_WT(trial,:),'Color',[bigdown_gs],'LineWidth',1.3);
    h=area(frame_taxis(1:1111),dist_pats_WT(trial,:),'LineStyle','-', 'FaceColor',[bigdown_gs], 'LineWidth',0.1);
    set(h,'FaceColor',[bigdown_gs],  'LineStyle','-'); 
    goodplot
    axis([0 3.5 0 150])
end
