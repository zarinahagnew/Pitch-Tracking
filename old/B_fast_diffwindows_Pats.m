...
%                     axis([1 1400 -350 350])
        ...
        %% convert to cents
        data_6b=data_6; % make copy
        for each_block=1:num_blocks;
            for d=1:10
                for iframe=1:1360
                    if data_6.goodpitchdata(each_block).data(d,iframe)==NaN
                       data_6b.goodpitchdata(each_block).data(d,iframe)=NaN;
                    else
                       data_6b.goodpitchdata(each_block).data(d,iframe)=1200*log2(data_6.goodpitchdata(each_block).data(d,iframe)/subj_MP_allsubs(each_subject).meanpitch);
                    end
                end
                
                for iframe=1:201
                    if data_6.prestep(each_block).data(d,iframe)==NaN
                       data_6b.prestep(each_block).data(d,iframe)=NaN;
                    else
                       data_6b.prestep(each_block).data(d,iframe)=1200*log2(data_6.goodpitchdata(each_block).data(d,iframe)/subj_MP_allsubs(each_subject).meanpitch);
                    end
                end                
                
                for iframe=1:201
                    if data_6.poststep(each_block).data(d,iframe)==NaN
                       data_6b.poststep(each_block).data(d,iframe)=NaN;
                    else
                       data_6b.poststep(each_block).data(d,iframe)=1200*log2(data_6.goodpitchdata(each_block).data(d,iframe)/subj_MP_allsubs(each_subject).meanpitch);
                    end
                end                
        ...
        for each_block=1:num_blocks;
            for d=1:10
                    data_6b.WTstd(each_block).wholetrial(d)=nanstd(data_6b.goodpitchdata(each_block).data(d,:));          % within trial stdev
                    data_6b.WTstd(each_block).prestep(d)=nanstd(data_6b(1).goodpitchdata(each_block).prestep_data(d,:));          % within trial stdev
                    data_6b.WTstd(each_block).poststep(d)=nanstd(data_6b(1).goodpitchdata(each_block).poststep_data(d,:));          % within trial stdev
                    
                    data_6b.wholetrial_WTstd_amp(each_block).wholetrial(d)=nanstd(data_6b.goodampdata(each_block).wholetrial_amp(d,:));          % within trial stdev
                    data_6b.prestep_WTstd_amp(each_block).wholetrial(d)=nanstd(data_6b.goodampdata(each_block).prestep_amp(d,:));          % within trial stdev
                    data_6b.proststep_WTstd_amp(each_block).wholetrial(d)=nanstd(data_6b.goodampdata(each_block).poststep_amp(d,:));          % within trial stdev
            end 
        end
        ...
        for each_block=1:num_blocks;
            ...
            subplot(5,2,10)
            plot(data_6b.goodpitchdata(each_block).data(d,:), 'c')
        ...
        for each_block=1:num_blocks;
            for itrial=1:10
                gaps(each_block).data(itrial)=countgaps(data_6.goodpitchdata(each_block).data(itrial,:), 9);
            end
        end
...
%     load (sprintf('%sALLDATA.mat',patient_info{isubj}.exprdir));
% 
%     %create empty variable for the good trials
%     good_trial=NaN(8,10);
%     curdir=cd;
...
%                         marker.data(each_block).data(d,i)=80;
%                     else
%                         marker.data(each_block).data(d,i)=NaN;
%                     end
%                 end
%             end
%         end
...
%                        data_6b.goodpitchdata(each_block).data(d,iframe)=NaN;
%                     else
%                        data_6b.goodpitchdata(each_block).data(d,iframe)=1200*log2(data_6.goodpitchdata(each_block).data(d,iframe)/subj_MP_allsubs(isubj).meanpitch);
%                     
%                     end
%                 end
%                 
...
%                        data_6b.prestep(each_block).data(d,iframe)=NaN;
%                     else
%                        data_6b.prestep(each_block).data(d,iframe)=1200*log2(data_6.goodpitchdata(each_block).data(d,iframe)/subj_MP_allsubs(isubj).meanpitch);
%                     end
%                 end                
%                 
%                 for iframe=1:201
...
%                        data_6b.poststep(each_block).data(d,iframe)=NaN;
%                     else
%                        data_6b.poststep(each_block).data(d,iframe)=1200*log2(data_6.goodpitchdata(each_block).data(d,iframe)/subj_MP_allsubs(isubj).meanpitch);
%                     end
%                 end                
%                 
%                 
