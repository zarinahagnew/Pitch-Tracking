...
%%pulldata/mat opens the figure that gill made and writes it out into
%%patient/mat and control.mat which are /Users/zagnew/Cereb_data/stuffforpaper/pitchpert
...
pat_colour=[0.45 0.45 0.45];
hc_colour=[0.7 0.7 0.7];
sig_colour=[.9 .9 .9];
...
%% figure 1 - up and down flipped and together but not averaged
...
%print(gcf, '-dpdf', '-r150', '/data/bil-mb4/zarinah-data/cerebellar-data/pitch-pert-ataxia/controls/figures/FinalFigureSplit2.pdf');
print(gcf, '-dpdf', '-r150', '/Users/zagnew/Cereb_data/stuffforpaper/pitchpert/figures/FinalFigureSplit2.pdf');
...
%print(gcf, '-dpdf', '-r150', '/data/bil-mb4/zarinah-data/cerebellar-data/pitch-pert-ataxia/controls/figures/FinalFigureSplit3.pdf');

print(gcf, '-dpdf', '-r150', '/Users/zagnew/Cereb_data/stuffforpaper/pitchpert/figures/FinalFigureSplit3.pdf');
...
%print(gcf, '-dpdf', '-r150', '/data/bil-mb4/zarinah-data/cerebellar-data/pitch-pert-ataxia/controls/figures/FinalFigureSplit.pdf');
print(gcf, '-dpdf', '-r150', '/Users/zagnew/Cereb_data/stuffforpaper/pitchpert/figures/FinalFigureSplit.pdf');
...
%print(gcf, '-dpdf', '-r150', '/data/bil-mb4/zarinah-data/cerebellar-data/pitch-pert-ataxia/controls/figures/FinalFigureAved.pdf');
print(gcf, '-dpdf', '-r150', '/Users/zagnew/Cereb_data/stuffforpaper/pitchpert/figures/FinalFigureAved.pdf');
...
%print(gcf, '-dpdf', '-r150', '/data/bil-mb4/zarinah-data/cerebellar-data/pitch-pert-ataxia/controls/figures/.pdf');
print(gcf, '-dpdf', '-r150', '/Users/zagnew/Cereb_data/stuffforpaper/pitchpert/figures/FinalFigureAved.pdf');
